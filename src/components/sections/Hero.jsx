    ...
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto flex flex-col items-center">
        <motion.div
          ...
          className="inline-block px-4 py-1.5 mb-6 text-sm rounded-full border border-primary/30 bg-black/50 backdrop-blur-sm text-primary shadow-[0_0_15px_rgba(0,255,159,0.3)]"
        >
          Mentorship · Tech Education · Web Development
        </motion.div>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl"
        >
          We teach students to build real products — and we build them too.
          From mentorship classes to fully deployed web apps for businesses across World.
        </motion.p>
        ...
        <motion.button
          ...
          className="flex items-center gap-2 text-sm text-gray-400 hover:text-[#00ff9f] transition-colors duration-200 group"
        >
          <LayoutGrid className="w-4 h-4 group-hover:scale-110 transition-transform" />
          Need a website built?
          <span className="text-[#00ff9f] underline underline-offset-2">View our catalog →</span>
        </motion.button>
      </div>
